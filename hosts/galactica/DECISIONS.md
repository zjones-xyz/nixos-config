...
> ⚠ **Read with §9 (2026-08-10).** The 2.1 TiB parachute measurement below is a
> property of the *data* and survives unchanged. The *mechanism* does not: this
> section assumes an in-place SnapRAID conversion, and a ZFS pool cannot be built
> in place over existing data. The window's shape has to be re-derived.
